...
> Status: **runs end-to-end** (Phases 0–3). Pay→gate→delegated inference, an autonomous answer-free-or-pay
> agent, and a serverless P2P storefront all work on a real GPU + a real testnet. Testnet only —
> a demonstration of the access-control/settlement primitive, not a live financial service.
