    ...
    if (req.method === 'GET' && p === '/api/state') {
      ...
      if (!wallet) {
        ...
        json(res, 200, {
          ...
          network: { name: cfg.network.name, label: cfg.network.label, explorer: cfg.network.explorer, symbol: cfg.network.settlementSymbol, gasSymbol: cfg.network.gasSymbol, faucet: cfg.network.faucet ?? null, gasIsSettlementToken: cfg.network.gasIsSettlementToken },
