...
- **M4b (trust signals):** seller **reputation** (quality / latency / completion-rate → marketplace + bookmarks + "Auto") + **verifier** (escalate confidently-wrong) + resilience (reconnect, error states).
